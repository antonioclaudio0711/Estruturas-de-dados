...
main() {
	...
	do {
		...
		printf("1 - Inserir um valor no início da lista\n");
		printf("2 - Inserir um valor no fim da lista\n");
		...
		switch(opcao) {
			case 1:
				system("cls");
				printf("Você selecionou a opção: 'Inserir um valor no início da lista'!\n");
			...
			case 2:
				system("cls");
				printf("Você selecionou a opção: 'Inserir um valor no fim da lista'!\n");
				printf("Digite o valor a ser inserido: ");
				scanf("%i", &valor);
			...
			case 3:
				system("cls");
				printf("Você selecionou a opção: 'Remover um valor da lista'!\n");
			...
			case 4:
				system("cls");
				printf("Você selecionou a opção: 'Imprimir a lista'!\n");
				imprimir(&lista);
				break;
